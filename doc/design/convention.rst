...
:doc:`goals`. The bugs it fixes are catalogued in `#714 <https://github.com/PyPSA/linopy/issues/714>`__.
...
zero (`#712 <https://github.com/PyPSA/linopy/issues/712>`__).
...
every operator (`#713 <https://github.com/PyPSA/linopy/issues/713>`__). To mark slots absent, use the mechanisms of §4 — a
bare NaN in a constant is not one of them.

The alternative — reading user NaN as "absent" instead of raising — was
discussed in `#627 <https://github.com/PyPSA/linopy/issues/627>`__ and closed: ambiguous overload of a numeric value
...
(`#736 <https://github.com/PyPSA/linopy/issues/736>`__).
...
(`#708 <https://github.com/PyPSA/linopy/issues/708>`__) — ``*`` aligning by label while ``+``, ``-``, ``/`` go by position —
disappears.
...
conflict, which is the `#295 <https://github.com/PyPSA/linopy/issues/295>`__ bug. The caller resolves it explicitly with
...
(Legacy projects implicitly and warns — scenario B of the `#732 <https://github.com/PyPSA/linopy/pull/732>`__/`#737 <https://github.com/PyPSA/linopy/pull/737>`__
...
they do not (`#707 <https://github.com/PyPSA/linopy/issues/707>`__).
...
are added under v1 only (`#703 <https://github.com/PyPSA/linopy/issues/703>`__) — as new operations with no legacy behaviour —
...
silently reindexed (`#827 <https://github.com/PyPSA/linopy/issues/827>`__). Under legacy the fast path matches positionally; v1
